...
//	    public static By basAiseHi=By.xpath("//*[@text='An OTP was sent to you']");
	    ...
	    public static By txtAutoReadingOTP=By.xpath("//*[@text='Auto Reading OTP']");   
	    public static By titleTruecaller=By.xpath("//*[@resource-id='com.truecaller:id/partnerLoginIntentText']");
	    public static By BtnSkipTrueCaller=By.xpath("//*[@resource-id='com.truecaller:id/continueWithDifferentNumber']");
	    public static By btnTryAgain=By.xpath("//*[@text='Try Again']");
	    public static By linkVerifyBySendingSMS=By.xpath("//*[@resource-id='sendingSMSbtn']");
	    public static By simcardnotfound=By.xpath("//*[@text='SIM card not found']");
}
