...
public class RingLoginPage {
	...
	public static By objAllowCamera=By.xpath("//*[@text='Allow' or @text='While using the app' or @text='WHILE USING THE APP']");
...
//	public static By OtpError = By.xpath("//*[@text='You have entered incorrect or expired OTP']");
	...
	public static By objLocAccess = By.xpath("//*[@text='Allow only while using the app' or @text='While using the app' or @text='WHILE USING THE APP']");
	
	//Phone access popup
	public static By objPhoneAccess = By.xpath("//*[@text='Allow' or @text='ALLOW']");
	
	//SMS access popup
	public static By objSMSAccess = By.xpath("//*[@text='Allow' or @text='ALLOW']");
	
	//checkbox1
	public static By ckycCheckBox = By.xpath("//*[@resource-id='ckycCheck']/android.view.ViewGroup");
	...
	//Menu select
	public static By objTopMenu = By.xpath("//*[@text='Available Limit' or @text='Limit Paused']/preceding-sibling::android.view.ViewGroup/descendant::android.view.ViewGroup");
	
	//Customer profile select
	public static By objProfileSelect = By.xpath("//*[@resource-id='userInfodetailView']");
	...
	public static By objProfileCrossBtn = By.xpath("//*[@resource-id='userhomeclosebtn']");
	//================================================================================================================
	public static By objScanQRPage = By.xpath("//*[@text='Scan any QR to get started']");
	public static By objMakePayment = By.xpath("//*[@text='Say hello to freedom!!']");
	public static By objMakePaymentLetsRingItBtn = By.xpath("//*[@text='Let’s RING it!']");
	public static By objMakePaymentPageProceedBtn = By.xpath("//*[@text='Proceed']");
	public static By objScanQRPageSignUp = By.xpath("//*[@text='Don’t have a QR code?']");
	public static By objSignUpLoginBt = By.xpath("//*[@text='Signup/Login']");
	public static By objlocationPopup = By.xpath("//*[@text='Allow Ring Debug to access this device’s location?']");
	public static By objGender = By.xpath("//*[@text='Male']/preceding-sibling::android.widget.RadioButton/descendant::android.view.ViewGroup");
	public static By selectCalenderImage=By.xpath("//*[@class='android.widget.ImageView' and ./parent::*[@id='uddobbtn']]");
	public static By selectCalenderTxt=By.xpath("//*[@resource-id='uddobbtn']/android.widget.TextView");
	public static By objCongratsPage = By.xpath("//*[contains(@text,'Congrats')]");
	public static By objApprovedRingLimit = By.xpath("//*[contains(@text,'Your approved RING limit is')]");
	public static By objApprovedRinglimitAmt = By.xpath("(//*[contains(@text,'Your approved RING limit is')]/following-sibling::android.widget.TextView)[1]");
	//public static By objIAcceptCheckBox = By.xpath("//*[@text='I accept the Ring’s Terms & Conditions & IT Act 2000 and Key Fact Statement']/preceding-sibling::android.widget.CheckBox");
	...
	public static By objEnterNewPIN = By.xpath("//*[@text='Enter New PIN']/(following-sibling::android.widget.TextView)[1]");
	public static By objReEnterMPIN = By.xpath("//*[contains(@text,'Re')]/(following-sibling::android.widget.TextView)[1]");
	public static By objContinueBtns = By.xpath("//*[contains(@text,'Continue')]");
...
//	public static By objLoginFacebook = By.xpath("//*[@text='Continue with Facebook']");
	//Terms of services footer link text
	public static By objTermsLink_PrivacyFooter = By.xpath("//*[@resource-id='termsandprivacy']");
//	//truecaller skip button
//	public static By objTruSkipBtn = By.xpath("//*[@text='SKIP']");
//	//None of the above button
//	public static By objNoneBtn = By.xpath("//*[@resource-id='com.google.android.gms:id/cancel']");
...
//	public static By objVerifyMobHeader = By.xpath("//*[@text='Verify Mobile']");
	//+91 country code
	public static By objCountryCode = By.xpath("//*[@text='+91']");
//	//Enter mobile text field
//	public static By objMobTextField = By.xpath("//*[@class='android.widget.EditText']");
	//Next button
	public static By objProceedBtn = By.xpath("//*[@text='Proceed']");
	//Invalid mobile no text
	public static By objMobError = By.xpath("//*[@text=' Please enter a valid mobile number']");
//	//entered mob number
//	public static By getEditMob(String editMob) {
//		return By.xpath("//*[@text='OTP Sent To +91 "+ editMob +" ']");
//	}
...
//	public static By resendOtpTxt = By.xpath("//*[@text='Resend OTP']");
	//Wrong OTP text
	public static By OtpError = By.xpath("//*[@text='Please enter a valid OTP']");
//	//Edit mobile number
//	public static By objEditMobNo = By.xpath("//*[@text='Edit']");
//	//OTP text place first
//	public static By objOtpTxtField1 = By.xpath("//*[@class='android.widget.EditText']");
...
//	public static By objLocAccess = By.xpath("//*[@text='WHILE USING THE APP']");
	//Location Deny
	public static By objLocDeny = By.xpath("//*[@resource-id='com.android.permissioncontroller:id/permission_deny_button']");
//	//Phone access popup
//	public static By objPhoneAccess = By.xpath("//*[@text='ALLOW']");
//	//SMS access popup
//	public static By objSMSAccess = By.xpath("//*[@text='ALLOW']");
	//permission denial
	public static By objPermDenial = By.xpath("//*[contains(@text,'You have denied')]");
	//Cancel button permission denial
	public static By objPermCancel = By.xpath("//*[@text='CANCEL']");
//	//checkbox1
//	public static By ckycCheckBox = By.xpath("(//*[@class='android.view.ViewGroup' and ./parent::*[@class='android.widget.ScrollView']]/*/*[@class='android.view.ViewGroup' and ./parent::*[@class='android.view.ViewGroup']])[3]");
	//unchecked checkbox
	public static By ckyCheckBox1 = By.xpath("(//*[@class='android.view.ViewGroup' and ./parent::*[@class='android.widget.ScrollView']]/*[@class='android.view.ViewGroup'])[4]");
//	public static By objAdHeader = By.xpath("//*[@text='You’ve been chosen!']");
//	//Ad close button
//	public static By objAdCloseBtn = By.xpath("//*[@class='android.view.ViewGroup' and ./parent::*[@class='android.view.ViewGroup' and ./parent::*[@class='android.view.ViewGroup'] and (./preceding-sibling::* | ./following-sibling::*)[@class='android.widget.ImageView']]]");
//	//available limit header 
...
//	public static By objOkGotitBtn = By.xpath("//*[@class='android.view.ViewGroup' and ./*[@text='Ok, Got It!']]");
	...
	public static By iconAddBank=By.xpath("//*[@text='Add Bank']");
	
	public static By profileIFSC=By.xpath("//*[@resource-id='text-input-outlined' and ./parent::*[@resource-id='NewBankIFSCCode']]");

	public static By profileAccountNumber=By.xpath("//*[@resource-id='text-input-outlined' and ./parent::*[@resource-id='NewBankAccNo']]");
	
	public static By profileConfirmAccNum=By.xpath("//*[@resource-id='text-input-outlined' and ./parent::*[@resource-id='NewBankConfirmAccNo']]");
	
	public static By profileAccHolder=By.xpath("//*[@resource-id='text-input-outlined' and ./parent::*[@resource-id='NewBankAccHolderName']]");
	
	public static By profileAccType=By.xpath("//*[@text='Account Type']");
	
	public static By profileAccTypeSavings=By.xpath("//*[@text='SAVINGS']");
	
	public static By btnContinue=By.xpath("//*[@text='Continue']");
	
public static By btnNoThanks=By.xpath("//*[@resource-id='noThankbtn1']");
	
	public static By btnYesExitApp=By.xpath("//*[@resource-id='android:id/button1']");
	
	public static By ckbboxWhatsapp=By.xpath("//*[@resource-id='whatsappCheck']");
}
